...
static void ce147_ldo_en(bool onoff)
{
	...
	if(onoff == TRUE) { //power on 
		...
		Set_MAX8998_PM_OUTPUT_Voltage(BUCK4, VCC_1p500);
		...
		Set_MAX8998_PM_OUTPUT_Voltage(LDO13, VCC_3p100);

		Set_MAX8998_PM_REG(ELDO13, 1);

		// Turn CAM_ISP_1.8V on
		Set_MAX8998_PM_OUTPUT_Voltage(LDO14, VCC_2p100);

		Set_MAX8998_PM_REG(ELDO14, 1);

		// Turn CAM_ISP_2.8V on
		Set_MAX8998_PM_OUTPUT_Voltage(LDO15, VCC_3p100);

		Set_MAX8998_PM_REG(ELDO15, 1);

		// Turn CAM_SENSOR_1.8V on
		Set_MAX8998_PM_OUTPUT_Voltage(LDO16, VCC_2p100);
...
static int s5ka3dfx_power_on()
{
	...
	// Turn CAM_SENSOR_A2.8V on
	Set_MAX8998_PM_OUTPUT_Voltage(LDO13, VCC_2p900);
	Set_MAX8998_PM_REG(ELDO13, 1);

	msleep(1);

	// Turn CAM_ISP_HOST_2.8V on
	Set_MAX8998_PM_OUTPUT_Voltage(LDO15, VCC_2p900);
	Set_MAX8998_PM_REG(ELDO15, 1);

	msleep(1);

	// Turn CAM_ISP_RAM_1.8V on
	Set_MAX8998_PM_OUTPUT_Voltage(LDO14, VCC_1p900);
	Set_MAX8998_PM_REG(ELDO14, 1);
